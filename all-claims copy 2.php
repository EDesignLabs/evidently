...
$queryTotal="SELECT id FROM claims ";
$resultsTotal=mysql_query($queryTotal) or die(mysql_error());

echo '<div class="claim-top">You have <span id="number">'.mysql_num_rows($results).'</span> new claims to vote on (of '.mysql_num_rows($resultsTotal).' total)<br/><br />
